...
Relational databases are table-based. SQL is a standard query language for retrieving data stored in a database.
...
An intermediary table containing foreign keys that reference the primary keys in the two related tables.
